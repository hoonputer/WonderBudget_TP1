# Starting ChromeDriver 114.0.5735.90 버젼확인
...
driver = webdriver.Chrome(service=service, options=options) # 드라이버 위치 경로


# goURL = 'https://flight.naver.com/flights/domestic/GMP-CJU-20230601?adult=1&fareType=Y' # 빠른 테스트용


for date in range(20230801, 20230832): # 20230801~20230831
...
df.to_csv('flight_data0801_0831.csv', index=False)  # index=False로 설정하여 인덱스 열을 저장하지 않습니다.
